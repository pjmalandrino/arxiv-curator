...
echo "Updating Keycloak frontend client redirect URIs..."
...
# Update the client with additional redirect URIs
curl -s -X PUT \
...
echo "Frontend client updated with port 3001 redirect URIs!"
